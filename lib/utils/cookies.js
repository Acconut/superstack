...
function Cookie(name, value, options) {
    ...
    this.delete = function() {
        this.set("");
        this.options.expires = new Date(811424262000);
    };
    ...
    this.toString = function() {
        ...
        return cookie.serialize(this._name, this._value, this.options);
    };
...
function CookieList(cookieStr) {
    ...
    this.get = function(name, returnObj) {
        ...
        return (c && c._value) ? c._value : null;
    };
