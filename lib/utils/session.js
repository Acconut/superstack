...
function SessionList(sid, cookieIsNotSet, obj) {
    
    /**
     * Cache
     * If it's null there is nothing cached yet
     */
    this._cache = obj || {};
...
SessionList.fromRequest = function(req, cb) {
    ...
    db.get(sid, function(err, result) {
        ...
        cb(null, new SessionList(sid, cookieIsNotSet, result));
    });
